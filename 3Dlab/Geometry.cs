...
namespace PolyMesh
{
    internal static class Geometry
    {
        ...
        public static float[,] zBuffer = new float[Settings.bitmapSize, Settings.bitmapSize];
        ...
        public static Vector3 MatrixVectorMult(Matrix4x4 M, Vector3 v)
        {
            float div = v.X * M.M41 + v.Y * M.M42 + v.Z * M.M43 + 1 * M.M44;
            return new Vector3(
                (v.X * M.M11 + v.Y * M.M12 + v.Z * M.M13 + 1 * M.M14) / div,
                (v.X * M.M21 + v.Y * M.M22 + v.Z * M.M23 + 1 * M.M24) / div,
                (v.X * M.M31 + v.Y * M.M32 + v.Z * M.M33 + 1 * M.M34) / div
                );
        }
        public static void zBufferClear()
        {
