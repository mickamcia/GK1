    ...
    internal class Utils
    {
        ...
        public static Model ParseModel(string path)
        {
            ...
            while ((line = streamReader.ReadLine()) != null)
            {
                ...
                {
                    case "v":
                        model.vertices.Add(new Vector3((float)Convert.ToDouble(parts[1]) * Settings.modelScale, (float)Convert.ToDouble(parts[2]) * Settings.modelScale, (float)Convert.ToDouble(parts[3]) * Settings.modelScale));
                        break;
                    case "vn":
